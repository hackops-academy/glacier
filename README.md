<p align="center">
  <img src="assets/glacier_banner.png" alt="Glacier — web application security scanner, made by HackOps Academy" width="100%">
</p>
...
**📖 Learn Glacier like a professional:** the full course is live at
**[hackops-academy.github.io/glacier](https://hackops-academy.github.io/glacier/)**
— 13 modules covering setup, the proxy, passive/active scanning, authenticated
testing, Repeater, Fuzzer, findings triage, API automation, and the full
methodology tying it all together.
...
- 📖 **[Full course — hackops-academy.github.io/glacier](https://hackops-academy.github.io/glacier/)**
  — a 13-module walkthrough on operating Glacier like a professional, from
  first setup through a complete engagement methodology.
